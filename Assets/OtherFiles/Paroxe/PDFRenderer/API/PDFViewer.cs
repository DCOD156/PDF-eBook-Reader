...
#pragma warning restore 414
        ...
        public bool SaveDocumentAsFile(string path)
        {
            ...
            {
                Debug.Log("Error while saving document: there is no document loaded.");
                return false;
            }

            if (!new Uri(path).IsWellFormedOriginalString())
            {
                Debug.Log("Error while saving document: the path is not well formed => " + path);
                return false;
            }
            ...
            {
                Debug.Log("Exception while saving document: " + ex);
            }
        ...
        {
            m_Internal.PageCountLabel.text = "(" + pageIndex + " / " + pageCount + ")";
        }
